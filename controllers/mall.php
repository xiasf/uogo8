...
class Mall extends IController
{
    public $layout='mall';
	...
	function consult_act()
	{
    	...
    	else
    	{
			...
			$referObj->add();
			$this->redirect('success?callback=/mall/products/id/'.$goods_id);
    	}
	}
	...
	function products()
	{
		...
		$this->config["seo_title"] = $goods_info["name"]." - ";//改变标题
