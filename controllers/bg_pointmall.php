 ...
 * @note  
 */
class bg_pointMall extends IController
{
	...
	// 活动报名
	function pointmall_signup_edit()
	{
	...
	// 活动报名
	function pointmall_signup_edit_act()
	{
		$id = IFilter::act(IReq::get('id'),'int');
		$activity_catObj = new IModel('activity_signup');
	...
	//[活动分类] 添加修改 [动作]
	function pointmall_cat_edit_act()
	{
		$id = IFilter::act(IReq::get('id'),'int');
		$activity_catObj = new IModel('activity_cat');
