...
/*            var width = $G('width').value,
        ...
        setImage: function(img){
            ...
            if(src) {
                ...
                $G("height").value = 'auto';//img.height || '';
        ...
        setPreview: function(){
            ...
            if(url) {
                ...
                preview.innerHTML = '<img src="' + url + '" width="' + width + '" border="' + border + 'px solid #000" />';
            }
        },
        getInsertList: function () {
            ...
            if(data['url']) {
                return [{
                    ...
                    style: "width:" + data['width'] + "px;height:auto;"
                }];
            } else {
                return [];
            }
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // 上传按钮
				...
				$fileWatermark = $wrap.find('#fileWatermark'),
            // 没选择文件之前的内容。
                ...
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        var params = utils.serializeParam(editor.queryCommandValue('serverparam')) || '',
							fw = $fileWatermark.get(0).checked==true?"1":"0",
                            url = utils.formatUrl(actionUrl + (actionUrl.indexOf('?') == -1 ? '?':'&') + 'encode=utf-8&fw='+fw+'&' + params);
							//alert(url);
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
				...
				data['fw'] = ($fileWatermark.get(0).checked==true?"1":"0");
            });
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
						...
						$file.attr("title","排序:"+$file.index())
                        $file.append('<span class="success">'+$file.index()+'</span>'); 
                    } else {
