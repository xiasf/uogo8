...
//alert(typeof window.ChineseDistricts)
jQuery(function ($) {

    'use strict';
	$.getJSON("city.picker.data.js",{},function(data){alert(data);window.ChineseDistricts = data});
    if (typeof window.ChineseDistricts === 'undefined') {
        throw new Error('The file "city.data.js" must be included first!');
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span form-control" style="' +
                    this.getWidthStyle(p.width) + 'height:' +
                    p.height + 'px;">' +
                    (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                    '<span class="title"></span><div class="fa fa-caret-down"></div>' + '</span>',
        ...
        getWidthStyle: function (w, dropdown) {
            if (this.options.responsive && !$.isNumeric(w)) {
                ...
                return 'width:' + (dropdown ? Math.max(450, w) : w) + 'px;';
            }
        },
