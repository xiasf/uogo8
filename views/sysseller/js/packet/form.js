...
jQuery(function($){
	window.form = $("form.validform").Validform({
		tiptype:function(msg,o,cssctl){
			var obj = $(o.obj);$(".Validform_checktip_"+obj.attr("name")).remove();
			if(o.type == 3){
				$("<div class='Validform_checktip animated bounce Validform_checktip_"+obj.attr("name")+"'><div class='Validform_arrow'><em></em><span></span></div>"+msg+"</div>").css({
					"left":obj.offset().left - 5,
					"top":obj.offset().top - 93
